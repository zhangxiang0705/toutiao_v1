function getUrlParam(paraName) {
	...
	var zx_flag = 0;
	var ch_flag = 0;
	if(province.indexOf('北京')!= -1||province.indexOf('上海')!= -1||province.indexOf('天津')!= -1||province.indexOf('辽宁')!= -1||province.indexOf('海南')!= -1){
		zx_flag = 1 ;
	}
	...
	if(dizhi.indexOf('北京')!= -1||dizhi.indexOf('新疆')!= -1||dizhi.indexOf('西藏')!= -1||dizhi.indexOf('天津')!= -1||dizhi.indexOf('河北')!= -1||dizhi.indexOf('山西')!= -1||dizhi.indexOf('内蒙古')!= -1||dizhi.indexOf('宁夏')!= -1||dizhi.indexOf('青海')!= -1||dizhi.indexOf('陕西')!= -1||dizhi.indexOf('甘肃')!= -1||dizhi.indexOf('辽宁')!= -1||dizhi.indexOf('吉林')!= -1||dizhi.indexOf('黑龙江')!= -1||dizhi.indexOf('山东')!= -1||dizhi.indexOf('江苏')!= -1||dizhi.indexOf('上海')!= -1||dizhi.indexOf('浙江')!= -1||dizhi.indexOf('安徽')!= -1||dizhi.indexOf('湖南')!= -1||dizhi.indexOf('湖北')!= -1||dizhi.indexOf('四川')!= -1||dizhi.indexOf('贵州')!= -1||dizhi.indexOf('云南')!= -1||dizhi.indexOf('重庆')!= -1||dizhi.indexOf('广东')!= -1||dizhi.indexOf('广西')!= -1||dizhi.indexOf('福建')!= -1||dizhi.indexOf('江西')!= -1||dizhi.indexOf('河南')!= -1||dizhi.indexOf('海南')!= -1){
		ch_flag = 1 ;
	}
